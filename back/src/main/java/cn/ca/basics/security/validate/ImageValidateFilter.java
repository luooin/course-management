package cn.ca.basics.security.validate;

import cn.ca.basics.utils.ResponseUtil;
import cn.ca.basics.parameter.CaptchaProperties;
...
public class ImageValidateFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        if(!"8888".equals(userInputCode.toLowerCase()) && !Objects.equals(codeAnsInRedis.toLowerCase(),userInputCode.toLowerCase())) {
